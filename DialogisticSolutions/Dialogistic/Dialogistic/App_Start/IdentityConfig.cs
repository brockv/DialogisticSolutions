...
namespace Dialogistic
{
    public class EmailService : IIdentityMessageService
    {
        ...
        private async Task ConfigSendGridasync(IdentityMessage message)
        {
            ...
            myMessage.SetFrom(new EmailAddress("dialogistic-noreply@gmail.com", "Dialogistic Support"));
            ...
            // See: https://docs.microsoft.com/en-us/azure/app-service-web/sendgrid-dotnet-how-to-send-email
